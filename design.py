...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fanuc_list_widget.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.fanuc_list_widget.addItem(item)
        ...
        item = QtWidgets.QListWidgetItem()
        self.mazatrol_list_widget.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.mazatrol_list_widget.addItem(item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.fanuc_list_widget.item(0)
        item.setText(_translate("MainWindow", "KORPUS-AP110"))
        item = self.fanuc_list_widget.item(1)
        item.setText(_translate("MainWindow", "SEDLO-AP110"))
        ...
        self.mazatrol_list_widget.setSortingEnabled(False)
        item = self.mazatrol_list_widget.item(0)
        item.setText(_translate("MainWindow", "GAIKA-ZALUPA.PBG"))
        item = self.mazatrol_list_widget.item(1)
        item.setText(_translate("MainWindow", "GAIKA-NEZALUPA.PBG"))
        ...
        self.info_window.setPlainText(_translate("MainWindow", "Всякая залупа, епта!"))
        ...
        self.scaner_path.setText(_translate("MainWindow", "F:\\200ML\\1"))
